...
#ifndef IRremoteSendRecvint_h
#define IRremoteSendRecvint_h
...
// GRR - TIMER1 16 bit --->
#define INIT_TIMER_COUNT1 (CLK*CLK - USECPERTICK*CLKSPERUSEC + CLKFUDGE)
...
// Defined in IRremoteSendRecv.cpp
